    ...
    return(
        ...
        <div>
            ...
            <div className="w-[80%] mx-auto mt-20 mb-20">
                ...
                <p className="w-full text-center rounded-4xl py-4 bg-gray-200 text-2xl">Search for dishes</p>
                </Link>
            </div>

            <div className="w-[80%] mx-auto mt-20 mb-20">
                <button className={`text-2xl py-2 px-10 mr-4 border rounded-2xl cursor-pointer  ${selected==='veg'?"bg-green-600":"bg-gray-300"} `} onClick={()=>setSelected(selected==='veg'?null:'veg')}>Veg</button>
